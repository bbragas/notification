...
{
    [TestClass]
    public class WithGetReportSmsQueryWithDataAndAllParamsFilled
    {
        private readonly IReadRepository _repository;
        private readonly Fixture _fixture = new();
        private readonly IEnumerable<Domain.Sms> _response;

        public WithGetReportSmsQueryWithDataAndAllParamsFilled()
        {
        ...
        [TestMethod]
        public void Should_Received_Get_With_Default_Fields()
